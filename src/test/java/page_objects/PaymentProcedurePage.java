...
public class PaymentProcedurePage extends BasePage {
    ...
    private final By PAYING_WITH_SEPA_DIRECT_DEBIT = By.xpath("//p[contains(normalize-space(), 'SEPA')]");
    ...
    public boolean clickPayingWithDirectDebitRadioButton(){
        return clickElement(PAYING_WITH_SEPA_DIRECT_DEBIT);
    }
}
